  ...
  if(this.props.budget&&this.props.cuisine&&this.props.interests) {
    return (
      <div className="filterList">
        <Selector arr={this.props.interests} selectValues={this.props.interestsFilters} onChangeAction={filterByInterests}  hint="Filter for Interests" />
        <Selector arr={this.props.cuisine} selectValues={this.props.cuisineFilters} onChangeAction={filterByCuisine}  hint="Filter for Cuisines" />
        <Selector arr={this.props.budget} selectValues={this.props.budgetFilters} onChangeAction={filterByBudget}  hint="Filter for Budget" />
      </div>
    )
  } else {
    return <Loader />
